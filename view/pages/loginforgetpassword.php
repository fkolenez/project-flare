    ...
    <div class="flex-container">
        <div class="row">
            ...
            <div class="loginBox col-md-">
                ...
                <form action="../../controler/auth/authbykey.php" method="post">
                    <div class="form-group">
                        <input class="inputFodase" id="uname" type="text" name="name" placeholder="Digite seu username">
                    </div>
                        <div class="form-group">
                        <input class="inputFodase" id="pass" type="password" name="passwordRecoveryKey" placeholder="Digite sua chave para recuperação de senha">
                    </div>
