    ...
    <div class="row rowBaixo">
        ...
        <div class="row d-flex justify-content-around pt-5">
            <div class="col-md-3 col-sm-12 d-flex justify-content-center w-3">
                <a href="../../controler/logout/logout.php"><button class="btn btn-outline BtnDanger" type="submit"><strong>Logout</strong></button></a> 
            </div>
                
            <div class="col-md-3  col-sm-12 d-flex justify-content-center">
                <a href="updatePerfil.php"><button class="btn btn-outline BtnWarning" type="submit"><strong>Alterar perfil</strong></button></a>
            </div>

            <div class="col-md-3 col-sm-12 d-flex justify-content-center">
                <a href="historico.php"><button class="btn btn-outline BtnSuccess"><strong>Historico</strong></button></a>
            </div>

            <div class="col-md-3 col-sm-12 d-flex justify-content-center">
                <a href="#">
                <button class="btn btn-outline BtnDanger" data-bs-toggle="modal" data-bs-target="#exampleModal" type="button">
